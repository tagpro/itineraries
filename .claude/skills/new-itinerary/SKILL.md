---
name: new-itinerary
description: Build or substantially rework a trip page in this repository, modelled on tassie-campervan-2026 — an installable, offline, checklist-carrying itinerary. Reads the real bookings out of Gmail, asks what the bookings cannot say, researches the route and the walks, and writes the day-by-day page. Use this when a trip needs planning or writing up here: "plan our Japan trip", "make a page for the Kimberley drive", "turn these bookings into a plan", "add a new trip" — including when the words "itinerary" and "page" are never said. Not for one-off travel questions, or for editing a section of a page that already exists.
---
